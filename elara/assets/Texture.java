...
public class Texture
{
	...
	{
		if (image == null && cachedScaledImage == null) return null;
		if (image == null && cachedScaledImage != null) return cachedScaledImage;
		...
		BufferedImage scaledBufferedImage = new BufferedImage(scaleToWidth, scaleToHeight, BufferedImage.TYPE_INT_ARGB);
		Image scaledImage = image.getScaledInstance(scaleToWidth, scaleToHeight, BufferedImage.SCALE_DEFAULT);
