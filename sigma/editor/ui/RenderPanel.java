...
public class RenderPanel extends JComponent implements KeyListener, 
	...
	/*
	 * The floor image is effectively the terrain on the map and
	 * has the base textures on the lowest layer that the player can walk on.
	 * Everything renders on top of this.
	 * 
	 * It is just an image and can be painted on and have textures added to it.
	 */
	private BufferedImage floorImage;
	private WritableRaster floorRaster;
	...
	public RenderPanel() {
		...
		// load mouse cursor
		cursorImage = new ImageIcon("res/cursor.png");
